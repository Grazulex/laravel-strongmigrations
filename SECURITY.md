...
We provide security updates for the following versions of Laravel Strong Migrations:
...
If you discover a security vulnerability within Laravel Strong Migrations, please send an email to [jms@grazulex.be](mailto:jms@grazulex.be). All security vulnerabilities will be promptly addressed.
...
When using Laravel Strong Migrations in your applications, we recommend:

1. **Keep Updated** - Always use the latest version of Laravel Strong Migrations
2. **Review Rules** - Understand which rules are enabled and why
...
Thank you for helping keep Laravel Strong Migrations and our users safe!
